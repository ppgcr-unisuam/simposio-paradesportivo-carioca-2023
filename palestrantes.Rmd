...
```{r palestrantes, eval = !sjmisc::is_empty(list.files("2023/Palestrantes.xlsx")), echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', out.width = "100%", results = "asis"}
library("dplyr")
